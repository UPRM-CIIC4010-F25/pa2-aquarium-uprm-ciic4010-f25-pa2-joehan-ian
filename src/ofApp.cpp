...
void ofApp::setup(){
    ...
    myAquarium = std::make_shared<Aquarium>(ofGetWindowWidth(), ofGetWindowHeight(), player, spriteManager);
    ...
    myAquarium->addAquariumLevel(std::make_shared<Level_3>(3, 15));
    myAquarium->addAquariumLevel(std::make_shared<Level_4>(4, 15));
